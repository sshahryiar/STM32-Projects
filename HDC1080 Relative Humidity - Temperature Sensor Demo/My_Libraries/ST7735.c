...
{
    unsigned char ch[5] = {0x20, 0x20, 0x20, 0x20, '\r'};
...
{
    unsigned char ch[7] = {0x20, 0x20, 0x20, 0x20, 0x20, 0x20, '\r'};
...
{
    unsigned char ch[6] = {0x2E, 0x20, 0x20, 0x20, 0x20, '\r'};
